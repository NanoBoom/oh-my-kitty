...
```conf
shell_integration enabled  # 增强终端功能（命令输出标记、提示符检测）
term xterm-kitty          # 使用 kitty 原生终端类型以支持高级键盘协议
```
...
- [Kitty 键盘快捷键配置](https://sw.kovidgoyal.net/kitty/conf/#keyboard-shortcuts)
- [Launch 命令语法](https://sw.kovidgoyal.net/kitty/launch/#syntax-reference)
- [Splits 布局文档](https://sw.kovidgoyal.net/kitty/layouts/#the-splits-layout)
- [Shell 集成](https://sw.kovidgoyal.net/kitty/shell-integration/)
